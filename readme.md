...
Если вы хотите опубликовать готовый сайт на InstantCMS 2, то сделайте следующее:
 ...
 3. В конфиге сайта в файле `icms2/system/config/config.php` пропишите реквизиты базы данных (название, пользователь, пароль), которые вы планируете использовать. Эти же реквизиты нужно будет сообщить мастеру установки на следующем шаге. **Важно:** в качестве хоста базы данных укажите `mysql` вместо `localhost`.
