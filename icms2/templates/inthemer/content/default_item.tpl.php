<?php
	...
	$this->inthemer_item = $item;
	$this->inthemer_fields = $fields;
	$this->inthemer_comments = !empty($item['comments_widget']) ? $item['comments_widget'] : '';
?>
...
<div class="content_item <?php echo $ctype['name']; ?>_item">
    ...
    <?php if ($props && array_filter((array)$props_values)) { ?>
		...
		<?php $this->inthemer_props = ob_get_clean(); echo $this->inthemer_props; ?>
    <?php } ?>
